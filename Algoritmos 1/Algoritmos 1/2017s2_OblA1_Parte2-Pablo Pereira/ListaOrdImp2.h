...
protected:
	...
	void AgregarOrdAux(const T &e, NodoABB<T>* &pos);
	void BorrarMinimoAux(NodoABB<T>* & pos);
	void BorrarMaximoAux(NodoABB<T>* & pos);
	void BorrarAux(NodoABB<T>* &arbol, T e);
	void ClonAux(NodoABB<T>* arbol, NodoABB<T>* &clon) const;
	bool ExisteAux(NodoABB<T>* arbol, const T &e) const;
	NodoABB<T>* MaximoAux(NodoABB<T>* arbol) const;
	NodoABB<T>* MinimoAux(NodoABB<T> *arbol) const;
	NodoABB<T>* RecuperarAux(NodoABB<T>* arbol, const T &e) const;
	void pasarALista(NodoABB<T>* arbol, ListaPosImp<T>* l) const;
};
